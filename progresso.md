# Progresso do MVP (plataforma de contratos)

## Checklist de tarefas
- [x] Criar progresso.md com checklist inicial
- [x] Reestruturar app (package, config, db, entrypoint) e atualizar dependências
